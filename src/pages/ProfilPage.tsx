...
export default function ProfilPage() {
  ...
  return (
    <AppLayout>
      <div className="space-y-8"> {/* Mengubah space-y-6 menjadi 8 agar jarak header ke card lebih pas */}
        ...
        {/* Card profil - Dibuat rata kiri tanpa flex center */}
        <div>
          <div className="w-full max-w-sm overflow-hidden rounded-xl border border-border bg-card shadow-card">
            ...
            <div className="divide-y divide-border px-1">
              <InfoRow 
                ...
                label="Peran"
                value={isAdmin ? "Administrator Sistem" : "Guru"} 
              />
              <InfoRow 
                icon={<Building2 className="h-4 w-4" />} 
                label="Instansi"
                value="SMK Smart Ar-Rahman" 
              />
              <InfoRow 
